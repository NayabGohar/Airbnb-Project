    ...
    <div className="border-b sticky top-0 z-50 bg-white/[95%]  ">
      <div className="flex justify-between items-center sm:mx-6 md:mx-10 lg:mx-12 ">
        ...
        <div className="hidden lg:flex justify-center items-center relative shadow-sm shadow-gray-400 border rounded-full ">
          ...
          <div className="bg-[#00008B] p-2 rounded-full mr-2">
        ...
        <div className="flex items-center pr-3  font-semibold text-gray-600">
          ...
          <div className="flex items-center border px-3 py-2 rounded-full gap-2 bg-[#00008B] text-white font-bold shadow-lg shadow-gray-300 hover:bg-white hover:text-darkblue duration-100 ease-out">
            <p>Sign in</p>
